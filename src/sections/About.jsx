...
export default function About() {
  ...
  return (
    <div className="bg-white py-20">
      <section className="relative min-h-screen flex items-center overflow-hidden max-w-7xl mx-auto px-6 md:px-16">
        {/* FULL BACKGROUND */}
        <img
          src={star}
          alt=""
          ...
          <div className="grid  gap-12 items-center">
            <div>
              ...
              <h1 className="font-headline text-5xl md:text-7xl font-bold text-primary tracking-tight leading-[1.1] mb-8">
                ...
                <span className="text-[#DDA23A] text-secondary italic">
                  Silicon Innovation
                </span>
              </h1>

              <p className="mt-5 text-gray-600 max-w-md">
                Nurturing a generation of developers who build for the dunya
                while securing their akhirah.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-[#f4f7fb] py-20 px-6 md:px-16 ">
        <div className="grid md:grid-cols-2 gap-8">
          <div className="group bg-white p-8 rounded-3xl shadow-md hover:shadow-xl transition hover:-translate-y-2">
            ...
            <h3 className="text-lg text-[#013463] font-semibold mb-2">
              Mission
            </h3>
      ...
      <section className="bg-white py-20 px-6 md:px-16">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <p className="text-xs uppercase text-[#DDA23A]  mb-2">
              The Genesis
            </p>
            <h2 className="text-2xl text-[#013463] md:text-3xl font-bold mb-4">
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-600 text-sm">
                Every line of code is an act of stewardship over the digital
                realm.{" "}
              </p>
              ...
              <p className="text-gray-600 text-sm">
                Built by students, for students, fostering a peer-to-peer
      ...
      <section className="bg-[#f4f7fb] py-20 px-6 md:px-16">
        <div className="text-center mb-12">
          <h2 className="text-2xl text-[#013463] md:text-3xl font-bold mb-2">
            Our Core Values
          </h2>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="group bg-white p-6 rounded-2xl text-center shadow-md hover:shadow-xl transition hover:-translate-y-2">
            ...
            <p className="text-black-600 text-sm">
              {" "}
              Building open-source tools that serve humanity as a form perpetual
              charity long after the code written.
            </p>
          </div>
          ...
          <div className="group bg-white p-6 rounded-2xl text-center shadow-md hover:shadow-xl transition hover:-translate-y-2">
            ...
            <h4 className="text-lg text-[#013463] font-semibold mb-2">
              Community Growth
            </h4>
            <p className="text-black-600 text-sm">
              Nuturing an environment where ever developer lifts another,
      ...
      <section className="bg-white py-20 px-6 md:px-16">
        <div className="bg-gradient-to-r from-[#0b2545] to-[#1e4b7a] text-white rounded-3xl p-10 text-center">
          ...
          <p className="text-gray-300 text-sm mb-6">
            ...
            technical and spritiual excellence. .
          </p>

          <div className="flex flex-col md:flex-row justify-center gap-4">
            <button
              onClick={() => navigate("/form")} // Change "/form" to your actual route path
              className="inline-block bg-yellow-500 text-black px-6 py-2 rounded-full font-medium hover:bg-yellow-600 transition-colors"
            >
